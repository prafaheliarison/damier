...
!function (A, e) {
  ...
  function t(A, e, t) {
    if (t || 2 === arguments.length) for (var r, B = 0, n = e.length; B < n; B++) {
  ...
  var HA = {
    ...
    if (46 === t && UA(r)) for (A.push(this.consumeCodePoint(), this.consumeCodePoint()), e = 8; UA(this.peekCodePoint(0));) {
      A.push(this.consumeCodePoint());
    }
    t = this.peekCodePoint(0);
    var r = this.peekCodePoint(1),
        B = this.peekCodePoint(2);
    if ((69 === t || 101 === t) && ((43 === r || 45 === r) && UA(B) || UA(r))) for (A.push(this.consumeCodePoint(), this.consumeCodePoint()), e = 8; UA(this.peekCodePoint(0));) {
      A.push(this.consumeCodePoint());
    }
    return [function (A) {
      var e = 0,
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/js/html2canvas.min.js");
/******/ 	
/******/ })()
;